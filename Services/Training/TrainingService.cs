...
public sealed class TrainingService
{
    ...
    private ILanguageModel CreateModel(ModelConfiguration config)
    {
    ...
    private (IOptimizer optimizer, LearningRateScheduler scheduler) CreateOptimizer(TrainingConfiguration config)
    {
